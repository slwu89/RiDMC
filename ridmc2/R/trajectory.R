#' @useDynLib ridmc2 ridmc_ctrajectory_alloc
#' @useDynLib ridmc2 ridmc_ctrajectory_step
#' @useDynLib ridmc2 ridmc_ctrajectory_getValue
#' @useDynLib ridmc2 ridmc_ctrajectory_getModel
#' @useDynLib ridmc2 ridmc_dtrajectory_alloc
#' @useDynLib ridmc2 ridmc_dtrajectory_step
#' @useDynLib ridmc2 ridmc_dtrajectory_getValue
#' @useDynLib ridmc2 ridmc_dtrajectory_getModel
#' @export
Trajectory <- function(idmc_model, par, var, time=1, transient=0,
  ...
  if(getModelType(m)=='C') { ##Continuous model
    ...
    ans$step <- function()
      .Call("ridmc_ctrajectory_step", trajectory)
    ans$getValue <- function()
      .Call("ridmc_ctrajectory_getValue", trajectory)
    ans$getModel <- function() {
      pp <- .Call("ridmc_ctrajectory_getModel", trajectory)
    ...
    ans$trajectory <- trajectory
    ans$step <- function()
      .Call("ridmc_dtrajectory_step", trajectory)
    ans$getValue <- function()
      .Call("ridmc_dtrajectory_getValue", trajectory)
    ans$getModel <- function() {
      pp <- .Call("ridmc_dtrajectory_getModel", trajectory)
