#' @useDynLib ridmc2 ridmc_model_alloc
#' @useDynLib ridmc2 ridmc_model_getInfos
#' @useDynLib ridmc2 ridmc_model_f
#' @useDynLib ridmc2 ridmc_model_g
#' @useDynLib ridmc2 ridmc_model_Jf
#' @useDynLib ridmc2 ridmc_model_NumJf
#' @useDynLib ridmc2 ridmc_model_setGslRngSeed
#' @export
Model <- function(filename=NULL, text = readLines(filename)) {
  ...
  pointer <- .Call("ridmc_model_alloc", text1)
...
buildModel <- function(pointer, text) {
  ...
  infos <- .Call("ridmc_model_getInfos", model)
  ...
  ans$f <- function(par, var)
    .Call("ridmc_model_f", model, as.double(par), as.double(var))
  ans$g <- function(par, var)
    .Call("ridmc_model_g", model, as.double(par), as.double(var))
  ...
  ans$NumJf <- function(par, var)
    matrix(.Call("ridmc_model_NumJf", model, as.double(par), as.double(var)), n.vars)
  ans$set.seed <- function(seed)
    invisible(.Call("ridmc_model_setGslRngSeed", model, as.integer(seed)))
